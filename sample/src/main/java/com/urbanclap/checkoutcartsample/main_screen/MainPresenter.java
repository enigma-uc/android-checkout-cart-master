...
class MainPresenter implements MainContract.Presenter {
    ...
    private void generateSections(List<PokemonTypesItem> pokemonTypesItems) {
        ...
        List<Section<PokemonCartBaseItem>> sections2 = new ArrayList<>();
        Integer i = 0;
        for (final PokemonTypesItem itr : pokemonTypesItems) {
            List<ItemData<PokemonCartBaseItem>> itemDataList2 = new ArrayList<>();
            ...
            itemDataList2.add(new CartItem((sectionItem)));
            addPokemonItemDataInList(itr.getPokemons(), itemDataList);
            addPokemonItemDataInList(itr.getPokemons(), itemDataList2);
            Section<PokemonCartBaseItem> section;
            Section<PokemonCartBaseItem> section2;
            View v;
         ...
         //   section.getStickyViewItem();

            if (i == 2) {
                section2 = new Section<>(itr.getUuid(), itemDataList2, new IStickyViewItem() {
                    @Override
                    public View createView(@NonNull ViewGroup parent) {
                        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_section_layout, parent, false);
                        TextView textView = view.findViewById(R.id.tv_itemSection_title);
                ...
                section2.getItemDataList().remove(2);
                section2.getItemDataList().remove(2);
                section2.getItemDataList().remove(2);
        ...
        view.showSections(sections, sections2);
    }
